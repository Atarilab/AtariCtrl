...
class MujocoVisualizer:
    ...
    def draw_box(self, pos, quat, size, color, label="", id=0):
        """
        Draw a box marker at the specified position and orientation.
        
        Args:
            pos: Position [x, y, z] in world frame
            quat: Quaternion [x, y, z, w] in world frame
            size: Half-extents [x, y, z] of the box
        ...
        self.viewer.add_marker(
            ...
            size=size,
            rgba=color,
            type=mujoco.mjtGeom.mjGEOM_BOX,  # pyright: ignore[reportAttributeAccessIssue]
            label=label,
            id=4000 + id,
        )
