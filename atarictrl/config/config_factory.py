...
from atarictrl.pipeline.pipeline_cfgs import PipelineCfg
...
CFG_REGISTRY: dict[str, tuple[str, str]] = {
    ...
    # ctrl
    "keyboard_ctrl": ("atarictrl.controller.keyboard_ctrl", "KeyboardCtrlCfg"),
    "joystick_ctrl": ("atarictrl.controller.joystick_ctrl", "JoystickCtrlCfg"),
    "unitree_ctrl": ("atarictrl.controller.unitree_ctrl", "UnitreeCtrlCfg"),
    "beyondmimic_ctrl": ("atarictrl.controller.beyondmimic_ctrl", "BeyondMimicCtrlCfg"),
    # pipeline
    "rl_pipeline": ("atarictrl.pipeline.rl_pipeline", "RlPipelineCfg"),
    "rl_multi_policy_pipeline": ("atarictrl.pipeline.rl_multi_policy_pipeline", "RlMultiPolicyPipelineCfg"),
}


def load_class(key: str) -> Any:
    module, cls_name = CFG_REGISTRY[key]
    return getattr(importlib.import_module(module, package="atarictrl.config.g1"), cls_name)
