...
from atarictrl.utils.util_func import matrix_from_quat, subtract_frame_transforms
...
class BeyondMimicPolicy(Policy):
    ...
    def get_observation(self, env_data, ctrl_data):
        ...
        if self.use_motion_from_model and self.command is not None:
            extras["command_dict"] = {
                "body_pos_w": self.command.get("body_pos_w"),
                "body_quat_w": self.command.get("body_quat_w"),
            }
        return obs, extras
