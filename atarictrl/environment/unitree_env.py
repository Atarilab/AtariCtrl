...
from atarictrl.environment.utils.unitree_command import (
    MotorMode,
    create_damping_cmd,
    create_zero_cmd,
    init_cmd_go,
...
from atarictrl.environment.utils.unitree_rotation import transform_imu_data
from atarictrl.tools.retarget import HandRetarget
from atarictrl.utils.rotation import TransformAlignment
from atarictrl.utils.util_func import calc_heading_quat_np, quat_rotate_inverse_np
    ...
    def update(self):
        ...
        if self._odometry_type == "ZED":
            ...
            if self.vicon_odometry.is_valid:
                ...
                self._base_pos = self.vicon_odometry.pos
                self._lin_vel = self.vicon_odometry.lin_vel
        ...
        if self._odometry_type == "VICON" and hasattr(self, "vicon_odometry"):
            ...
            if box_segment_name is not None and self.vicon_odometry.is_segment_valid(box_segment_name):
                ...
                if box_pos_key in all_segments_data:
                    env_data["box/base_pos_w"] = all_segments_data[box_pos_key]
                if box_quat_key in all_segments_data:
                    env_data["box/base_quat"] = all_segments_data[box_quat_key]
