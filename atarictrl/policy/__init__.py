from atarictrl.utils.module_registry import Registry

from .base_policy import Policy
from .policy_cfgs import PolicyCfg

policy_registry = Registry(package="atarictrl.policy", base_class=Policy)
...
policy_registry.add("BeyondMimicObjectPolicy", ".beyondmimicobject_policy")