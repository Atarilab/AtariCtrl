...
script:
  - [joystick_ctrl.py](../atarictrl/controller/joystick_ctrl.py)
...
> For KEY name and more details, please refer to the [joystick.py](../atarictrl/controller/utils/joystick.py)
...
script:
- [unitree_ctrl.py](../atarictrl/controller/unitree_ctrl.py)
...
script:
  - [keyboard_ctrl.py](../atarictrl/controller/keyboard_ctrl.py)
...
💡For more details, please refer to the [keyboard.py](../atarictrl/controller/utils/keyboard.py)
