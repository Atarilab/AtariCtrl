...
import atarictrl.controller
from atarictrl.controller import Controller, ControllerHook, CtrlCfg
...
class CtrlManager:
    ...
    def __init__(
        ...
        for cfg_ctrl in self.cfg_ctrls or []:
            ...
            ctrl_class: type[Controller] = getattr(atarictrl.controller, ctrl_type)
...
if __name__ == "__main__":
    ...
    from atarictrl.controller.ctrl_cfgs import JoystickCtrlCfg, KeyboardCtrlCfg
    from atarictrl.environment.dummy_env import DummyEnv
